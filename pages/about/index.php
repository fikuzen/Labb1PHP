...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Vem är Christoffer Rydberg</title>
        ...
        <dív id="container">
            <div id="wrapper">
                ...
                <nav>
                    ...
                    <a href="/pages/about/" class="span1 active btn btn-primary">Om mig</a>
                ...
                <div id="content">
                    <div class="row">
                        <div class="span8">
                            ...
                            <hr />
                            <p>Jag är en av dina elever under kommande kurs, sommaren har varit seg, saknat skolan. Äntligen får man snart komma tillbaka igen, under sommaren har jag hunnit starta upp mitt egna företag för frilansering av hemsidor samt hunnit programmerat litegrann.</p>
                            <p>Tidigare har jag inte programmerat jättemycket utöver det vi har hunnit lära oss under år 1.</p>
